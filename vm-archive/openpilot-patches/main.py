...
class MainLayout(Widget):
  def __init__(self):
    ...
    # MODIFIED: Start in ONROAD mode for dashcam/webcam LKAS
    ...
    # DISABLED: Skip onboarding for webcam LKAS mode
  ...
  def _handle_onroad_transition(self):
    # HARDCODED: Skip transition logic, always onroad
    pass

  def _set_mode_for_state(self):
    # HARDCODED: Always show ONROAD view for webcam LKAS
